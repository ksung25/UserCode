...
void computeAccSelWe(const TString conf,       // input file
  ...
  // efficiency files
  TString dataHLTEffName("../Efficiency/May23_EleHLTEff/analysis/eff.root");
  TString zeeHLTEffName("../Efficiency/Zee_EleHLTEff/analysis/eff.root");
  TString dataGsfSelEffName("../Efficiency/May23_EleGsfSelEff/analysis/eff.root");
  TString zeeGsfSelEffName("../Efficiency/Zee_EleGsfSelEff/analysis/eff.root");
...
//  TString zeeGsfEffName("../Efficiency/Zee_EleGsfEff/analysis/eff.root");
  if(charge==1) {
    dataHLTEffName = "../Efficiency/May23_EleHLTEff_pos/analysis/eff.root";
    zeeHLTEffName  = "../Efficiency/Zee_EleHLTEff_pos/analysis/eff.root";
    dataGsfSelEffName = "../Efficiency/May23_EleGsfSelEff_pos/analysis/eff.root";
    zeeGsfSelEffName  = "../Efficiency/Zee_EleGsfSelEff_pos/analysis/eff.root";
...
//    zeeGsfEffName  = "../Efficiency/Zee_EleGsfEff_pos/analysis/eff.root";
  ...
  if(charge==-1) {
    dataHLTEffName = "../Efficiency/May23_EleHLTEff_neg/analysis/eff.root";
    zeeHLTEffName  = "../Efficiency/Zee_EleHLTEff_neg/analysis/eff.root";
    dataGsfSelEffName = "../Efficiency/May23_EleGsfSelEff_neg/analysis/eff.root";
    zeeGsfSelEffName  = "../Efficiency/Zee_EleGsfSelEff_neg/analysis/eff.root";
