...
void fitRecoilWe2(TString infilename,  // input ntuple
  ...
  fnamev.push_back("/data/blue/ksung/EWKAna/8TeV/Selection/Wenu/ntuples/top_select.root"); isBkgv.push_back(kTRUE); 
  fnamev.push_back("/data/blue/ksung/EWKAna/8TeV/Selection/Wenu/ntuples/ewk_select.root"); isBkgv.push_back(kTRUE);
