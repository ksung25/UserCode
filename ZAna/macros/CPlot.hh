...
//  void Clear(){}
  ...
  void AddGraph(TGraph *gr, TString drawopt, int color=kBlack, int marksty=kFullDotLarge);    
  void AddGraph(TGraph *gr, TString label, TString drawopt, int color=kBlack, int marksty=kFullDotLarge);
  void AddGraph(TFile *f, TString grName, TString drawopt, int color=kBlack, int marksty=kFullDotLarge);
  void AddGraph(TFile *f, TString grName, TString label, TString drawopt, int color=kBlack, int marksty=kFullDotLarge);
