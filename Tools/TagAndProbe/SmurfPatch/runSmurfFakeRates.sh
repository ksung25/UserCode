...
root -b -q plotEff.C+\(\"ElectronFR.bins\",0,0,0,0,\"${ELE2012}\",\"HWW_Electron${OUTNAME}_FR_IDISO\",\"png\",1,0,0,$ElectronFakeRate,$ElectronFO,$ElectronIDIsoNumerator2012\)
root -b -q plotDataMC.C+\(\"HWW_Electron${OUTNAME}_FR_IDISO/extra\",\"null\",\"HWW_Electron${OUTNAME}_FR_IDISO/eff.root\"\)
root -b -q printEff.C+\(\"HWW_Electron${OUTNAME}_FR_IDISO/extra\",\"HWW_Electron${OUTNAME}_FR_IDISO/eff.root\",\"HWW_Electron${OUTNAME}_FR_IDISO/eff.root\"\)
...
root -b -q plotEff.C+\(\"MuonFR.bins\",0,0,0,0,\"${MU2012}\",\"HWW_Muon${OUTNAME}_FR_IDISO\",\"png\",1,0,0,$MuonFakeRate,$MuonFO,$MuonIDIsoNumerator2012\)
root -b -q plotDataMC.C+\(\"HWW_Muon${OUTNAME}_FR_IDISO/extra\",\"null\",\"HWW_Muon${OUTNAME}_FR_IDISO/eff.root\"\)
root -b -q printEff.C+\(\"HWW_Muon${OUTNAME}_FR_IDISO/extra\",\"HWW_Muon${OUTNAME}_FR_IDISO/eff.root\",\"HWW_Muon${OUTNAME}_FR_IDISO/eff.root\"\)
