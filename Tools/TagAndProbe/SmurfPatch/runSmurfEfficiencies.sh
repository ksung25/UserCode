...
root -b -q plotEff.C+\(\"ElectronOffline.bins\",0,0,0,0,\"${MCEE}\",\"HWW_ElectronMC${OUTNAME}_NM1Eff_ID\",\"png\",1,5,0,$ElectronTagAndProbeMC,$ElectronIsoDenominator2012,$ElectronIDNumerator2012,60,120\)
...
root -b -q plotEff.C+\(\"ElectronOffline.bins\",0,0,0,0,\"${MCEE}\",\"HWW_ElectronMC${OUTNAME}_NM1Eff_Iso\",\"png\",1,5,0,$ElectronTagAndProbeMC,$ElectronIDDenominator2012,$ElectronIsoNumerator2012,60,120\)
...
root -b -q plotEff.C+\(\"MuonOffline.bins\",0,0,0,0,\"${MCMM}\",\"HWW_MuonMC${OUTNAME}_NM1Eff_ID\",\"png\",1,5,0,$MuonTagAndProbeMC,$MuonIsoDenominator2012,$MuonIDNumerator2012,60,120\)
...
root -b -q plotEff.C+\(\"MuonOffline.bins\",0,0,0,0,\"${MCMM}\",\"HWW_MuonMC${OUTNAME}_NM1Eff_Iso\",\"png\",1,5,0,$MuonTagAndProbeMC,$MuonIDDenominator2012,$MuonIsoNumerator2012,60,120\)
