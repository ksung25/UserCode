...
# ID wrt Iso
root -b -q plotEff.C+\(\"ElectronOffline.bins\",2,0,2,2,\"${ELE2012A}\",\"HWW_Electron2012A_NM1Eff_ID\",\"png\",1,0,0,$ElectronTagAndProbe,$ElectronIsoDenominator2012,$ElectronIDNumerator2012\,60,120,\"$MC\"\)
...
# Iso wrt ID
root -b -q plotEff.C+\(\"ElectronOffline.bins\",2,0,2,2,\"${ELE2012A}\",\"HWW_Electron2012A_NM1Eff_Iso\",\"png\",1,0,0,$ElectronTagAndProbe,$ElectronIDDenominator2012,$ElectronIsoNumerator2012\,60,120,\"$MC\"\)
...
root -b -q printEff.C+\(\"HWW_Electron2012A_NM1Eff_TrigSgl/extra\",\"HWW_Electron2012A_NM1Eff_TrigSgl/eff.root\",\"HWW_Electron2012A_NM1Eff_TrigSgl/eff.root\"\)
...
root -b -q printEff.C+\(\"HWW_Electron2012A_NM1Eff_TrigLeadDbl/extra\",\"HWW_Electron2012A_NM1Eff_TrigLeadDbl/eff.root\",\"HWW_Electron2012A_NM1Eff_TrigLeadDbl/eff.root\"\)
...
root -b -q printEff.C+\(\"HWW_Electron2012A_NM1Eff_TrigTrailDbl/extra\",\"HWW_Electron2012A_NM1Eff_TrigTrailDbl/eff.root\",\"HWW_Electron2012A_NM1Eff_TrigTrailDbl/eff.root\"\)
...
# ID wrt Iso
root -b -q plotEff.C+\(\"MuonOffline.bins\",2,0,2,2,\"${MU2012A}\",\"HWW_Muon2012A_NM1Eff_ID\",\"png\",1,0,0,$MuonTagAndProbe,$MuonIsoDenominator2012,$MuonIDNumerator2012\,60,120,\"$MC\"\)
...
# Iso wrt ID
root -b -q plotEff.C+\(\"MuonOffline.bins\",2,0,2,2,\"${MU2012A}\",\"HWW_Muon2012A_NM1Eff_Iso\",\"png\",1,0,0,$MuonTagAndProbe,$MuonIDDenominator2012,$MuonIsoNumerator2012\,60,120,\"$MC\"\)
...
root -b -q printEff.C+\(\"HWW_Muon2012A_NM1Eff_TrigSgl/extra\",\"HWW_Muon2012A_NM1Eff_TrigSgl/eff.root\",\"HWW_Muon2012A_NM1Eff_TrigSgl/eff.root\"\)
...
root -b -q printEff.C+\(\"HWW_Muon2012A_NM1Eff_TrigLeadDbl/extra\",\"HWW_Muon2012A_NM1Eff_TrigLeadDbl/eff.root\",\"HWW_Muon2012A_NM1Eff_TrigLeadDbl/eff.root\"\)
...
root -b -q printEff.C+\(\"HWW_Muon2012A_NM1Eff_TrigTrailDbl/extra\",\"HWW_Muon2012A_NM1Eff_TrigTrailDbl/eff.root\",\"HWW_Muon2012A_NM1Eff_TrigTrailDbl/eff.root\"\)
